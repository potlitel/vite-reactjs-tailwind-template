export default function Settings() {
  return (
    <>
      <div class="mx-6">
        <h1 class="my-6 text-3xl">Settings</h1>
        <div class="relative items-center justify-center">
          <h1 class="text-center text-2xl font-bold p-4 bg-gray-800 text-gray-400">
            ...
            <div class="lg:m-4 shadow-md hover:shadow-lg hover:bg-gray-100 rounded-lg bg-white my-12 mx-8">
              ...
              <div class="p-4">
                ...
                <p class="text-justify">
                  ...
                  from to suits his some. Saw him counsel begun mother though
                  but. Ofttimes soils of since mighty pollution.
                </p>
                <div class="mt-5">
                  <a
                    href=""
